...
module.exports = function userActivate(server, auth, userId) {
  ...
  var same = server.plugins.acls.getACLValue(auth, 'users.reactivate.bypass.priority.admin');
  var lower = server.plugins.acls.getACLValue(auth, 'users.reactivate.bypass.priority.mod');
